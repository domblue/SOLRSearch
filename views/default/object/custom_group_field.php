<?php 
	...
	*/
	...
	$title .= "<a href='" . $vars["url"] . "solrsearch/forms/group_field/" . $vars['entity']->guid  . "' class='solr-search-popup'><span class='elgg-icon elgg-icon-settings-alt' title='" . elgg_echo("edit") . "'></span></a>";
	$title .= "</div>";
