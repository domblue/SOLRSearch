...
$tabs = array (array("text" => elgg_echo("admin:appearance:solr_profile_fields"),
		"href" => "admin/appearance/solr_profile_fields", "selected" => $profile_fields_selected));


if (elgg_is_active_plugin("groups")) {
	$tabs[] = array("text" => elgg_echo("admin:appearance:solr_group_fields"),
			"href" => "admin/appearance/solr_group_fields", "selected" => $group_fields_selected);
}
