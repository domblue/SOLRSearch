...
$searchon_input = elgg_view('input/dropdown', array('name' => 'searchon',
		'id' => 'solrsearch_searchon',
		'value' => $vars['searchon'],
		'options_values' => array('all' => elgg_echo('solr:searchon:all'),
...
?>
<div>
	<label> <?php echo $searchon_label; ?><br /> <?php echo $searchon_input;
	?>
	</label>
</div>
<?php
...
/** @todo create a dynamic list */
$searchtype_input = elgg_view('input/dropdown', array('name' => 'searchtype',
...
?>
<div>
	<label> <?php echo $searchtype_label; ?><br /> <?php echo $searchtype_input;
	?>
	</label>
</div>
<?php
